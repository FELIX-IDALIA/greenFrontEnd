...
// Action Footer
const ActionFooter = ({ handleButtonClick, showPopup, isSidebarOpen }) => {
    return (
        <>
            ...
            >
                ...
                <button className="flex items-center gap-2 bg-gray-100 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-300 transition">
